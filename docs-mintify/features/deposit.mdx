...
Deposits let you move tokens from your public wallet into the Yona privacy pool. Once deposited, your tokens become private notes that only you can access. Your deposit amount is visible when depositing, but all future transactions with these funds will be private.
